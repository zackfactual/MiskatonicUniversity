namespace MiskatonicUniversity.Migrations
{
    ...
    public partial class LovecraftNames : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.Course", "Title", c => c.String(maxLength: 100));
            AlterColumn("dbo.Department", "Name", c => c.String(maxLength: 100));
            ...
            AlterColumn("dbo.OfficeAssignment", "Location", c => c.String(maxLength: 100));
